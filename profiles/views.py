...
def add_certificate(request):
    ...
    return render(request, 'profiles/add_certificate.html', {'form': form})
...
def edit_certificate(request, pk):
    ...
    return render(request, 'profiles/edit_certificate.html', {'form': form})
...
def add_cover_letter(request):
    ...
    return render(request, 'profiles/add_cover_letter.html', {'form': form})
...
def edit_cover_letter(request,pk):
    ...
    return render(request, 'profiles/edit_cover_letter.html', {'form': form})
...
def add_self_introduction(request):
    ...
    return render(request, 'profiles/add_self_introduction.html', {'form': form})
...
def edit_self_introduction(request, pk):
    ...
    return render(request, 'profiles/edit_self_introduction.html', {'form': form})
